...
// LFS originals live in GitHub; Sites receives full assets in the build archive.
const result=spawnSync('git',['-c','credential.helper=','-c','core.hooksPath=.cache/empty-hooks','push',credential.remote_url,`HEAD:refs/heads/${credential.branch}`],{
